...
$(window).on('load', function () {
    parallax(document.getElementById('level1'), -1.5, 0);
    parallax(document.getElementById('level2'), -1, 0);
    parallax(document.getElementById('level3'), -1.3, 0);
});
...
function parallax(target, layer, scrollinit) {
    ...
    // Add below gallery when nearing the end of the column
...
function append_gallery(column) {
    var container = $(column).find('.agencyPra-box'),
